...
using Examination_System.Procedures;
...
namespace Examination_System.Data
{
    public partial class ITI_EXAMContext
    {
        ...
        protected void OnModelCreatingGeneratedProcedures(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Add_TopicResult>().HasNoKey().ToView(null);
    ...
    public partial class ITI_EXAMContextProcedures : IITI_EXAMContextProcedures
    {
        ...
        public virtual async Task<List<Add_TopicResult>> Add_TopicAsync(string topicName, int? courseId, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<Add_TopicResult>("EXEC @returnValue = [dbo].[Add_Topic] @topicName, @courseId", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<Exam_GenerationResult>> Exam_GenerationAsync(int? Ex_id, string ins_id, int? crs_id, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<Exam_GenerationResult>("EXEC @returnValue = [dbo].[Exam_Generation] @Ex_id, @ins_id, @crs_id", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<Read_Instructor_Courses_By_Instructor_IdResult>> Read_Instructor_Courses_By_Instructor_IdAsync(int? instructorId, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
        ...
        public virtual async Task<List<Read_Questions_With_Students_AnswersResult>> Read_Questions_With_Students_AnswersAsync(int? examId, int? studentId, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
