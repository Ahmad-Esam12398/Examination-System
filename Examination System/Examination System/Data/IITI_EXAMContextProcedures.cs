...
namespace Examination_System.Data
{
    public partial interface IITI_EXAMContextProcedures
    {
        ...
        Task<List<Add_QuestionResult>> Add_QuestionAsync(string Qtitle, string QAnswer, string Qtype, int? Qweight, string Qchoice1, string Qchoice2, string Qchoice3, string Qchoice4, int? instructorId, int? crs_id, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<List<Assign_Exam_For_TrackResult>> Assign_Exam_For_TrackAsync(int? trackId, int? BranchId, int? ExamId, DateTime? ExamDate, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<List<Delete_Exam_By_IdResult>> Delete_Exam_By_IdAsync(int? id, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<List<Exam_GenerationResult>> Exam_GenerationAsync(string ins_id, int? crs_id, int? tf, int? duration, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<List<Read_All_Exams_For_CourseIdResult>> Read_All_Exams_For_CourseIdAsync(int? crsId, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
