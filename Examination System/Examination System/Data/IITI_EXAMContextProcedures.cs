...
namespace Examination_System.Data
{
    public partial interface IITI_EXAMContextProcedures
    {
        ...
        Task<List<Add_TopicResult>> Add_TopicAsync(string topicName, int? courseId, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<List<Exam_GenerationResult>> Exam_GenerationAsync(int? Ex_id, string ins_id, int? crs_id, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<List<Read_Instructor_Courses_By_Instructor_IdResult>> Read_Instructor_Courses_By_Instructor_IdAsync(int? instructorId, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
